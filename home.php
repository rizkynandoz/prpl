  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#tampilanawal">HOME</a></li>
  ...
  <h3 class="text-center">Pengguna Terakhir</h3>
          ...
          <table id="myTable">
            <tr class="header">
			  ...
			  <th style="width:20%;">Uang Pembayaran</th>
			  <th style="width:20%;">Kembalian</th>
            </tr>
            <tr>
              <td>rizky</td>
              <td>25 Mei 2018</td>
              <td>Sirloin Steak With Spacy Sauce| Hamburger Chiken | Avocado Juice</td>
              <td>Rp. 187.000,00</td>
			  <td>Rp. 200.000,00</td>
			  <td>Rp. 13.000,00</td>
            </tr>
			 <tr>
              <td>nurul</td>
              <td>25 April 2018</td>
              <td>Chiken Steak Eith Honey Sauce | Hamburger Chiken | Ice Caffe Late</td>
              <td>Rp. 36.000,00</td>
			  <td>Rp. 36.000,00</td>
			  <td>Rp. 0,00</td>
            </tr>
