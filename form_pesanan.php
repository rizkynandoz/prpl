...
<h2>Masukkan Data Pemesan Dan Pesanan</h2>
<div class="container">
  ...
  <form action="simpan_pesanan.php" method="post">
	...
	<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="nama" pattern="[A-Za-z]+$" title="hanya huruf" required />
      </div>
    </div>
    <div class="row">
      <div class="col-25">
	...
	<div class="inputa">
	 ...
	 <div id="row">
	  <div class="col-20">
        <label for="fname">Bayar : </label>
      </div>
	  <div class="col-75">
		<input type="text" name="bayar" id="bayar" class="h2" onkeyup="hitung2();" required="" size="40" onkeypress="return isNumberKey(event)" >
	  </div>
	</div>
	 <div class="inputa">
      <div class="col-20">
        <label for="fname">Kembalian : </label>
      </div>
      <div class="col-75">
        <input type="text" name="kembalian" id="kembalian" class="i2" readonly size="40">
      </div>
	 </div>
    <div class="row">
